...
desiredSize = [int(2560/20), int(1600/20)]

coolspot = {"center": [-.743643135, .131825963], "pom": [.000014628/2*0.85, .000014628/2/2560*1600*0.85]}

mainspot = {"center": [-.75, 0], "pom": [1.5, 1.5/2560*1600]}

center = mainspot["center"]
...
def outToColor(its):
    esto = scaling(its) #1 - math.log2(its[0]) / math.log2(its[1])
